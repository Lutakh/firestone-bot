...
| 4.3 Platform + vision layers | started | `dpi.py`, `window.py` (win32), `capture.py`, `atlas.py`, `viewport.py`, `probes.py`, `input.py` exist with viewport/probe tests; `process.py`, INI tests and live smoke test todo |
