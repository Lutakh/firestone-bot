...
MapStart(){
    ...
    Leftover.Insert(Object("x",884,"y",233))
    Leftover.Insert(Object("x",828,"y",375))
    Leftover.Insert(Object("x",923,"y",369))
    Leftover.Insert(Object("x",1442,"y",418))
    Leftover.Insert(Object("x",538,"y",190))
    Leftover.Insert(Object("x",1297,"y",193))
    Leftover.Insert(Object("x",1099,"y",894))
